...
#SBATCH --job-name=dawg-l1three33
#SBATCH --output=/gscratch/raivn/andy132/dawg/results/frontier_logs/l1three33-%A_%a.out
#SBATCH --requeue
...
python scripts/26_generate_l1_data.py --pages-file data/chunk_l1_b_three33.txt --out results/l1_three33 \
  --qa-per-page 1 --npatch 3 --total-area 10 --eps-min 12 --eps-max 24 --iters 50 --optim momentum \
